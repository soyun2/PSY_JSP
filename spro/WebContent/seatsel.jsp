	...
	$('document').ready(function(){
		...
		*/
		$('button').on('click',function(obj){
			...
			$(this).attr('class','btn btn-danger w80');   //attr=attribute를 뜻하는 약어(해당하는 attr에 속성 적용)
